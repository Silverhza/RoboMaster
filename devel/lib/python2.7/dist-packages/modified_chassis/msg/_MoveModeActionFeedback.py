...
"""autogenerated by genpy from modified_chassis/MoveModeActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveModeActionFeedback(genpy.Message):
  _md5sum = "da04156907a50ca887d7ed06388b3a26"
  _type = "modified_chassis/MoveModeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','modified_chassis/MoveModeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveModeActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = modified_chassis.msg.MoveModeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = modified_chassis.msg.MoveModeFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.state_keeping
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.state_keeping,) = _get_struct_f().unpack(str[start:end])
      return self
