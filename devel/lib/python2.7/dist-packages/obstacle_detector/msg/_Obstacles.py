...
class Obstacles(genpy.Message):
  _md5sum = "3d18886bf3de3d0abbd8f4ab62b1ac0b"
...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v12 = val1.segment
        _v13 = _v12.first_point
        _x = _v13
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v14 = _v12.last_point
        _x = _v14
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      for val1 in self.segments:
        _v15 = val1.first_point
        _x = _v15
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v16 = val1.last_point
        _x = _v16
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.circles)
      buff.write(_struct_I.pack(length))
      for val1 in self.circles:
        ...
        buff.write(_get_struct_2d().pack(_x.radius, _x.true_radius))
        _v19 = val1.segment
        _v20 = _v19.first_point
        _x = _v20
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v21 = _v19.last_point
        _x = _v21
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = obstacle_detector.msg.SegmentObstacle()
        _v22 = val1.first_point
        _x = _v22
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v23 = val1.last_point
        _x = _v23
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_x.radius, _x.true_radius,) = _get_struct_2d().unpack(str[start:end])
        _v26 = val1.segment
        _v27 = _v26.first_point
        _x = _v27
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        _v28 = _v26.last_point
        _x = _v28
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
