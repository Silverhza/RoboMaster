...
"""autogenerated by genpy from ros_yolo/ArmorPoints.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','ros_yolo/Box[6]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bbox is None:
        self.bbox = [ros_yolo.msg.Box() for _ in range(6)]
    else:
      self.header = std_msgs.msg.Header()
      self.numDetected = 0
      self.bbox = [ros_yolo.msg.Box() for _ in range(6)]
