...
(cl:defmethod freq-val ((m <ShootCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roborts_msgs-srv:freq-val is deprecated.  Use roborts_msgs-srv:freq instead.")
  (freq m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ShootCmd-request>)))
  ...
  "8a7441c08a86e123da484ba84c6284f7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ShootCmd-request)))
  "Returns md5sum for a message object of type 'ShootCmd-request"
  "8a7441c08a86e123da484ba84c6284f7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ShootCmd-request>)))
  ...
  (cl:format cl:nil "uint8 STOP = 0~%uint8 ONCE = 1~%uint8 CONTINUOUS = 2~%uint8 mode~%uint8 number~%uint16 freq~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ShootCmd-request)))
  "Returns full string definition for message of type 'ShootCmd-request"
  (cl:format cl:nil "uint8 STOP = 0~%uint8 ONCE = 1~%uint8 CONTINUOUS = 2~%uint8 mode~%uint8 number~%uint16 freq~%~%~%"))
