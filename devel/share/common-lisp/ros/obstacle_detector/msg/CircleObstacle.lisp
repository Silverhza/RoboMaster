...
(cl:defclass <CircleObstacle> (roslisp-msg-protocol:ros-message)
  ((center
   ...
   (segment
    :reader segment
    :initarg :segment
    :type obstacle_detector-msg:SegmentObstacle
    :initform (cl:make-instance 'obstacle_detector-msg:SegmentObstacle)))
)
...
(cl:defmethod segment-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detector-msg:segment-val is deprecated.  Use obstacle_detector-msg:segment instead.")
  (segment m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CircleObstacle>)))
  ...
  "0b960765a2e073d18b58abefb071095b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CircleObstacle)))
  "Returns md5sum for a message object of type 'CircleObstacle"
  "0b960765a2e073d18b58abefb071095b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CircleObstacle>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point center      # Central point [m]~%geometry_msgs/Vector3 velocity  # Linear velocity [m/s]~%float64 radius                  # Radius with added margin [m]~%float64 true_radius             # True measured radius [m]~%obstacle_detector/SegmentObstacle segment    # Keep track of the segment which the circle was spawned~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: obstacle_detector/SegmentObstacle~%geometry_msgs/Point first_point  # First point of the segment [m]~%geometry_msgs/Point last_point   # Last point of the segment [m]~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CircleObstacle)))
  "Returns full string definition for message of type 'CircleObstacle"
  (cl:format cl:nil "geometry_msgs/Point center      # Central point [m]~%geometry_msgs/Vector3 velocity  # Linear velocity [m/s]~%float64 radius                  # Radius with added margin [m]~%float64 true_radius             # True measured radius [m]~%obstacle_detector/SegmentObstacle segment    # Keep track of the segment which the circle was spawned~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: obstacle_detector/SegmentObstacle~%geometry_msgs/Point first_point  # First point of the segment [m]~%geometry_msgs/Point last_point   # Last point of the segment [m]~%~%~%"))
