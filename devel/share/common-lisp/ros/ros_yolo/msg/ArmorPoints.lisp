...
(cl:defclass <ArmorPoints> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bbox
    :reader bbox
    :initarg :bbox
    :type (cl:vector ros_yolo-msg:Box)
   :initform (cl:make-array 6 :element-type 'ros_yolo-msg:Box :initial-element (cl:make-instance 'ros_yolo-msg:Box))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmorPoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorPoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_yolo-msg:<ArmorPoints> is deprecated: use ros_yolo-msg:ArmorPoints instead.")))
...
(cl:defmethod numDetected-val ((m <ArmorPoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_yolo-msg:numDetected-val is deprecated.  Use ros_yolo-msg:numDetected instead.")
  (numDetected m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmorPoints>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bbox)))
    (cl:dotimes (i 6)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ros_yolo-msg:Box))
