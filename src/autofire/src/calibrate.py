...
class GimbalController(object):
    ...
    def get_lidar_dis(self, msg):
        ...
        print("dist:",self.lidar_distance)
        print("pitch:",pitchTest)
    ...
    def shoot_one(self, cmd_fric, cmd_shoot):
        ...
        cmd_shoot(1, 2)
        T.sleep(3)
        res = cmd_fric(False) # Turn off the fric wheel
    ...
    def adjust_pitch_angle(self, tar_angle):
        ...
        while True:
            ...
            if T.time()-start_time > 1:
                print('Pitch ANgle', cmd.pitch_angle)
                break
...
if __name__ == '__main__':
    ...
    # contorl.shoot_one(cmd_fric, cmd_shoot)

    for i in range(-33, 34):
        pitch_angle = float(i)/100
        control.adjust_pitch_angle(pitch_angle)
