...
class GimbalController(object):
    ...
    def box2dis(self, box):
        centerx,centery=self.box_center(box)
        
        boxdis = 18.18*centery**(-0.63)
        ...
        if self.distance == 0:
            ...
            if dist>3:
                ...
                if self.shoot_enable:
                    cmd_fric(True, self.speed, self.speed)
    ...
    def shootController(self):
        ...
        res=cmd_shoot(2,1,self.freq)# STOP, ONCE, CONTINUOUS, mode,number freq
