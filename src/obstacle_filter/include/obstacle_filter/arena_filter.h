...
bool IsPointInAerna(Point& p, float t, float wall_t, float centre_t)
{
	return IsPointInB1(p, t) || IsPointInB2(p, centre_t) || IsPointInB3(p, t) || IsPointInB4(p, centre_t) || IsPointInB5(p, t) || IsPointInB6(p, centre_t) || IsPointInB7(p, t) || IsPointInB8(p, centre_t) || IsPointInB9(p, t) || 
	IsPointInEdge1(p, wall_t) || IsPointInEdge2(p, wall_t) || IsPointInEdge3(p, wall_t) || IsPointInEdge4(p, wall_t);
}

bool IsPointInAerna(Point& p, float t, float wall_t)
{
	return IsPointInB1(p, t) || IsPointInB2(p, t) || IsPointInB3(p, t) || IsPointInB4(p, t) || IsPointInB5(p, t) || IsPointInB6(p, t) || IsPointInB7(p, t) || IsPointInB8(p, t) || IsPointInB9(p, t) || 
	IsPointInEdge1(p, wall_t) || IsPointInEdge2(p, wall_t) || IsPointInEdge3(p, wall_t) || IsPointInEdge4(p, wall_t);
}
...
{
	return IsPointInB1(p, t) || IsPointInB2(p, t) || IsPointInB3(p, t) || IsPointInB4(p, t) || IsPointInB5(p, t) || IsPointInB6(p, t) || IsPointInB7(p, t) || IsPointInB8(p, t) || IsPointInB9(p, t) || 
	IsPointInEdge1(p, t*1.5) || IsPointInEdge2(p, t*1.5) || IsPointInEdge3(p, t*1.5) || IsPointInEdge4(p, t*1.5);
}
