...
class LocalPlannerNode {
 public:
  ...
  void UpdatePlanStartTime(const geometry_msgs::PoseStamped &msg);
  ros::Time planning_start_time;
 ...
 private:
  ...
  //! control frequency
  double frequency_;
  // FOR CANCELLING PLANNING
  ros::Publisher cancel_pub_;
  ros::Publisher cancel_pub_local_;
  ros::Publisher fake_goal_pub_;
