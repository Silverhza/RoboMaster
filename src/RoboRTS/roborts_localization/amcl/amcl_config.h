...
struct AmclConfig {
  void GetParam(ros::NodeHandle *nh) {
      ...
      nh->param<double>("laser_min_range", laser_min_range, 0.3);
      nh->param<double>("laser_max_range", laser_max_range, 8.0);
      nh->param<int>("laser_max_beams", laser_max_beams, 10);
      nh->param<int>("min_particles", min_particles, 10);
      nh->param<int>("max_particles", max_particles, 500);
      ...
      nh->param<double>("odom_alpha1", odom_alpha1, 0.05);
      nh->param<double>("odom_alpha2", odom_alpha2, 0.05);
      nh->param<double>("odom_alpha3", odom_alpha3, 0.05);
      nh->param<double>("odom_alpha4", odom_alpha4, 0.05);
      nh->param<double>("odom_alpha5", odom_alpha5, 0.003);
      nh->param<double>("update_min_d", update_min_d, 0.05);
      nh->param<double>("update_min_a", update_min_a, 0.03);
      ...
      nh->param<bool>("use_global_localization", use_global_localization, true);
