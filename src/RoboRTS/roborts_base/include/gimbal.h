...
class Gimbal: public Module {
 ...
 private:
  ...
  //! ros publisher for gimbal gyro angle
  ros::Publisher     ros_pub_gimbal_gyro_ecd_angle_;
  ...
  geometry_msgs::TransformStamped gimbal_tf_fixed;
  //! ros gimbal tf broadcaster
  tf::TransformBroadcaster        tf_broadcaster_;
  tf::TransformBroadcaster tf_broadcaster_fixed;
