...
class Chassis: public Module{
 ...
 private:
  ...
  /**
   * @brief Imu data callback in ROS
   * @param vel_acc imu data from xsens
   */
  void ImuInfoCallback(const sensor_msgs::Imu::ConstPtr &imu_data);
  ...
  //! ros subscriber for imu data
  ros::Subscriber ros_sub_imu_data;
